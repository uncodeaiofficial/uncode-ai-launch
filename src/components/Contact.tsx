              ...
              <form onSubmit={handleSubmit} className="card-surface p-6 md:p-8 flex flex-col gap-5">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      required
                      type="text"
                      className="w-full h-11 px-4 rounded-lg bg-secondary border-none text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary transition-shadow"
                ...
                <div>
                  ...
                  <textarea
                    required
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg bg-secondary border-none text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary transition-shadow resize-none"
                    placeholder="We need to process 10M documents per day..."
                  />
                </div>
                <button
                  type="submit"
                  className="pulse-cta h-12 rounded-lg bg-foreground text-background font-medium text-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                >
                  Send Message
                  <ArrowRight size={16} />
                </button>
